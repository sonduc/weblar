      ...
      <div class="modal-content">
         ...
         <form id="add_new">
            <div class="modal-body">
                ...
                <fieldset class="form-group">
                  <label>Email</label>
                  <input type="email" class="form-control" id="email" placeholder="Nhập tên">
                </fieldset>
                <fieldset class="form-group">
                  <label>Địa chỉ</label>
                  <input type="text" class="form-control" id="address" placeholder="Nhập tên">
                </fieldset>
                <fieldset class="form-group">
...
@endsection
@section('script')
<script src="{{ asset('admin_assets/ajax/user.js') }}"></script>
@endsection
